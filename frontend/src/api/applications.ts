...
export default {
  ...
  // New method to fetch all applications
  getAll: async (): Promise<BrokerApplicationsListResponseDto> => {
    const data = await get<{}, BrokerApplicationsListResponseDto>(
      <HttpGetRoute>'/applications',
